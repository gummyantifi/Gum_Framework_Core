...
Config.weaponShops = { 
    Valentine = {
        ...
        ammo = {
            ["Repeaters"] = {
                ["Repeater - Normal"] = {price = 1.50,item = "ammorepeaternormal",},
                ["Repeater - Express"] = {price = 7.00,item = "ammorepeaterexpress",},
                ["Repeater - Velocity"] = {price = 2.50,item = "ammorepeatervelocity",},
                ["Repeater - Splitpoint"] = {price = 3.50,item = "ammorepeatersplitpoint",},
            },

            ["Revolvers"] = {
                ["Revolver - Normal"] = {price = 1.50,item = "ammorevolvernormal",},
                ["Revolver - Express"] = {price = 7.00,item = "ammorevolverexpress",},
                ["Revolver - Velocity"] = {price = 2.50,item = "ammorevolvervelocity",},
                ["Revolver - Splitpoint"] = {price = 3.50,item = "ammorevolversplitpoint",},
            },
            ["Rifles"] = {
                ["Rifle - Normal"] = {price = 1.50,item = "ammoriflenormal",},
                ["Rifle - Express"] = {price = 7.00,item = "ammorifleexpress",},
                ["Rifle - Velocity"] = {price = 1.90,item = "ammoriflevelocity",},
                ["Rifle - Splitpoint"] = {price = 2.50,item = "ammoriflesplitpoint",},
                ["Elephant Rifle Ammo"] = {price = 7.00,item = "ammoelephant",},
                },
            ["Shotgun"] = {
                ["Shotgun - Normal"] = {price = 1.50,item = "ammoshotgunnormal",},
                ["Shotgun - Slug"] = {price = 2.80,item = "ammoshotgunslug",},
            },
            ["Pistols"] = {
                ["Pistol - Normal"] = {price = 1.50,item = "ammopistolnormal",},
                ["Pistol - Express"] = {price = 7.00,item = "ammopistolexpress",},
                ["Pistol - Rychlostní"] = {price = 1.90,item = "ammopistolvelocity",},
                ["Pistol - Splitpoint"] = {price = 2.50,item = "ammopistolsplitpoint",},
            },
            ["Arrows"] = {
                ["Normal arrows"] = {price = 0.05,item = "ammoarrmownormal",},
                ["Small arrows"] = {price = 0.10,item = "ammoarrowsmallgame",},
            },
           ["Varmint munice"] = {
                ["Varmint ammo"] = {price = 0.20,item = "ammovarmint",},
                ["Varmint tranq"] = {price = 0.40,item = "ammovarminttranq",},
            },
            ["Throww"] = {
                ["Ammo for Knives"] = {price = 0.05,item = "ammoknives",},
                ["Ammo for Tomahawk"] = {price = 0.05,item = "ammotomahawk",},
                ["Ammo for Bollas"] = {price = 2.50,item = "ammobolla",},
            },
...
Config.ammo = {
    ...
    ["Throwing"] = {
		...
		["Cleaver Ammo"] = {
            key = "AMMO_HATCHET_CLEAVER",  
            item = "ammohatchetcleaver",
            playeritem = {"WEAPON_MELEE_CLEAVER"},
            maxammo = 5, 
            guncheck = 0  , 
            qt = 5,
        },
		["Hunter Hatchet Ammo"] = {
            key = "AMMO_HATCHET_HUNTER",  
            item = "ammohunterhatchet",
            playeritem = {"WEAPON_MELEE_HATCHET_HUNTER"},
            maxammo = 5, 
            guncheck = 0  , 
            qt = 5,
        },
