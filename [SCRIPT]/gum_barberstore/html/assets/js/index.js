    ...
    window.addEventListener('message', function(event) {
        ...
        if (item.type === "barber_open") {
            if (item.status == true) {
                ...
                document.getElementById('BEARDSSTABLE_CHECK').checked = item.BEARDSSTABLE_CHECK;
                ...
                document.getElementById('SHADOWS_CHECK').checked = item.SHADOWS_CHECK;
                ...
                document.getElementById('LIPSTICKS_CHECK').checked = item.LIPSTICKS_CHECK;
                ...
                document.getElementById('BRUSH_CHECK').checked = item.BRUSH_CHECK;
                ...
                document.getElementById('EYELINNERS_CHECK').checked = item.EYELINNERS_CHECK;
                ...
                document.getElementById('EYEBROWS_CHECK').checked = item.EYEBROWS_CHECK;
                ...
                document.getElementById('EYEBROWS_CHECK').checked = item.EYEBROWS_CHECK;
                document.getElementById("MOLES_CHECK").value = item.MOLES_CHECK;
                ...
                document.getElementById("FRECKLES_CHECK").checked = item.FRECKLES_CHECK;
                ...
                document.getElementById("AGEING_CHECK").checked = item.AGEING_CHECK;
                ...
                document.getElementById("ACNE_CHECK").checked = item.ACNE_CHECK;
                document.getElementById("ACNE_TYPE").value = item.ACNE_TYPE;
                document.getElementById("ACNE_OPACITY").value = item.ACNE_OPACITY*10;
                document.getElementById("COMPLEX_CHECK").checked = item.COMPLEX_CHECK;
                ...
                document.getElementById("DISC_CHECK").checked = item.DISC_CHECK;
                document.getElementById("DISC_TYPE").value = item.DISC_TYPE;
                document.getElementById("DISC_OPACITY").value = item.DISC_OPACITY*10;
                document.getElementById("SCARS_CHECK").checked = item.SCARS_CHECK;
                ...
                document.getElementById("SPOTS_CHECK").checked = item.SPOTS_CHECK;
